...
static DX_VEC3 const SOURCE = { 0.f, 0.f, 0.f };
...
static int dx_mesh_viewer_scene_render(dx_mesh_viewer_scene* self, dx_context* context, dx_f32 delta_seconds, int canvas_width, int canvas_height) {
  dx_mat4_set_ortho(&self->projection_matrix, -1, +1, -1, +1, -1, +1);
  //dx_mat4_set_perspective(&scene->projection_matrix, 60.f, (dx_f32)canvas_width / (dx_f32)canvas_height, +0.1f, 100.f);
  update_viewer(self);
