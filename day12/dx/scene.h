...
struct dx_scene {
  ...
  int (*render)(dx_scene* scene, dx_context* context, int canvas_width, int canvas_height);
...
/// @return @a 0 on success. A non-zero value on failure.
int dx_scene_render(dx_scene* scene, dx_context* context, int canvas_width, int canvas_height);
